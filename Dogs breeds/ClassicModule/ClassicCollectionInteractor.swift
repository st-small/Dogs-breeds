//
//  ClassicCollectionInteractor.swift
//  Dogs breeds
//
...
public protocol ClassicCollectionBusinessLogic {
    func makeRequest(request: ClassicCollection.Model.Request)
}

public protocol ClassicCollectionDataStore {
    var breeds: [BreedItemModel] { get }
}

public class ClassicCollectionInteractor: ClassicCollectionBusinessLogic, ClassicCollectionDataStore {
    
    // MARK: - Data
    public var breeds = [BreedItemModel]()
    
    // MARK: - Services
    public var presenter: ClassicCollectionPresentationLogic?
    
    // MARK: - Main logic
    public func makeRequest(request: ClassicCollection.Model.Request) {
        switch request {
        case .breeds:
            loadBreeds()
        }
